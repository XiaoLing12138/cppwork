...
int n;
float v1[200000000] = { 0 };
float v2[200000000] = { 0 };
...
/*
    chrono::steady_clock::time_point startB = chrono::steady_clock::now();

    chrono::steady_clock::time_point endB = chrono::steady_clock::now();
*/

    cout << "Self:"
         << result1+result2+result3+result4+result5+result6+result7+result8 << endl;
...
*/
	cout << "Self took "
		...
		<< "ms.\n";
/*    cout << "Blas took "
        << chrono::duration_cast<chrono::milliseconds>(endB - startB).count()
        << "ms.\n";
*/
	input.close();
	return 0;
